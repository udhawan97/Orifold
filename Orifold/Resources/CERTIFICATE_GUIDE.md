...
Orifold is free and open source, and **signing costs you nothing**. This guide is only for people
...
third-party product. You buy it directly from the provider; Orifold never charges for signing.
...
|---|---|---|---|
| Sign for yourself, a team, or testing | **Self-signed** (generate in Orifold) | Free | "Valid, but identity not verified" until they trust it once |
...
1. In Orifold's **Signatures** panel, choose **Digital Signature → Generate self-signed ID**.
2. Enter your name/email and a password to protect the key. Orifold stores it in your macOS Keychain.
...
3. **Receive your Digital ID.** Providers deliver it either as a downloadable **`.p12` / `.pfx`
   ...
   - If it's a **`.p12`/`.pfx` file**: you can import it straight into Orifold.
   - If it's a **hardware token**: install the vendor's driver, then add the ID to your macOS
     Keychain; Orifold will list it under **Choose Keychain Digital ID**.
...
**Do I have to pay to sign?** No. Signing in Orifold is always free. You only pay if you choose a
