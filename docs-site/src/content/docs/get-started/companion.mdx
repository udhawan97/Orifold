...
<div class="of-pet-pair">
	<figure>
		<img src="/Orifold/assets/gami-figure.svg" alt="Gami, the origami Bernedoodle companion — dark folded paper with a cream blaze and floppy ears." width="180" height="180" />
		<figcaption><strong>Gami</strong> · the Bernedoodle</figcaption>
	</figure>
	<figure>
		<img src="/Orifold/assets/ori-figure.svg" alt="Ori, the origami Siberian companion — slate folded paper with a cream ruff and tufted ears." width="180" height="180" />
		<figcaption><strong>Ori</strong> · the Siberian</figcaption>
	</figure>
</div>
