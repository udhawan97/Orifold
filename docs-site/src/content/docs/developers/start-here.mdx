...
Orifold is a native macOS PDF workspace: Swift 5.9+, 100% SwiftUI, local PDF engines plus a signing pipeline, <Stat name="tests" /> tests, and no document uploads. Its narrow network surface is limited to user-authorized updates, trusted signing timestamps, and system-managed translation language-model downloads. This page orients you before you open the tree.
