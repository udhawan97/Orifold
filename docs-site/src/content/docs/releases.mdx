...
their final count. Update and restore handoffs now stop safely when quit is cancelled, while
failed session markers prevent the helper from starting and leave the verified download ready
